...
urlpatterns = [
    ...
    path('reports/comprehensive/', views.ComprehensiveReportView.as_view(),
         name='comprehensive_report'),
    path('reports/maintenance/', views.MaintenanceHistoryReportView.as_view(),
         name='maintenance_report'),
    path('reports/requests/', views.RequestSummaryReportView.as_view(),
         name='request_summary_report'),
    path('reports/vendor-performance/', views.VendorPerformanceReportView.as_view(),
         name='vendor_performance_report'),
    path('reports/department-distribution/', views.DepartmentDistributionReportView.as_view(),
         name='department_report'),
    path('reports/request-turnaround/', views.RequestTurnaroundReportView.as_view(),
         name='turnaround_report'),
]
